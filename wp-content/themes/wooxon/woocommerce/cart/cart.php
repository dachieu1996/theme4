<?php
/**
 * Cart Page || eidit added sku code || cart totall css calss
 *
						...
						<td class="product-subtotal" data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>">
							...
							<?php
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="remove mfp-close icon-cross2" aria-label="%s" data-product_id="%s" data-product_sku="%s">&times;</a>',
			...
			<tr>
				<td colspan="7" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon  d_flex align-items-center">
					...
					<button type="submit" class="button f_r_md" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
