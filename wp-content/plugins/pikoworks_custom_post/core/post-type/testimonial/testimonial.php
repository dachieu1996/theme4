...
if (!class_exists('piko_Shortcode_testimonial')) {
    class piko_Shortcode_testimonial
    {
        ...
        function testimonial_shortcode($atts)
        {
            ...
            if(  function_exists('pikoworks_is_mobile') && !pikoworks_is_mobile() ){ 
            ...
            if( $is_slider == 'yes' && $use_responsive == '0' || function_exists('pikoworks_is_mobile') && pikoworks_is_mobile() ){
                 $col_class = 'col-12';
            }

            $slide_class = 'piko-carousel-grid row';
            $data_slick = '';
            if($is_slider == 'yes' || function_exists('pikoworks_is_mobile') && pikoworks_is_mobile()){
            ...
            <div class="<?php echo esc_attr( $css_class) ?>">                
                ...
                <?php 
                    while ( $query->have_posts() ) : $query->the_post(); 
                        ...
                        $prefix = 'piko_';
                        $job = esc_html(get_post_meta(get_the_ID(), 'job', true));
                        ...
                        if(!empty($urls)){
                            $job = '<a class="c_s3" href="'.esc_url($urls).'">' .esc_html($job) .'</a>';
                        }
