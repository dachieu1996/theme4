		...
		<div class="variations">
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
				<div class="product-attribute">
					...
					</div><?php  echo end( $attribute_keys ) === $attribute_name ? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations dib" href="#" onClick="window.location.reload()">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) : ''; ?>
				</div>
			<?php endforeach;?>
		</div>
