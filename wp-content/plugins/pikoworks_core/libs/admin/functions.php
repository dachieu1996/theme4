        ...
        <div class="piko-support-page">
            <div class="piko-tabs">
                <div class="piko-tabs-header">
                    ...
                    <a href="http://themepiko.com/support/" target="_blank">Visit our support Page</a>
                </div>
...
if(!function_exists('pikoworks_core_get_remote_faq')) {
    function pikoworks_core_get_remote_faq() {
        $url = 'http://themepiko.com/support/faq/faq-developer-documentation/';
...
//                preg_match("/<article[^>]*id=\"content\">(.*?)<\\/article>/si", $page_html, $match);
//                $faq_html = $match[1];
...
//        }
//        echo $faq_html;
        echo 'You can open ticket or Themeforest item comment your purchase item  <a href="https://themeforest.net/user/themepiko/portfolio" target="_blank">Get Themeforest item</a><br><br>';
