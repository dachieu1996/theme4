...
class pikoworks_theme_Admin {
    ...
    public function add_wp_toolbar_menu() {
        ...
        if ( current_user_can( 'edit_theme_options' ) ) {
            ...
            $pikoworks_parent_menu_title = '<span class="ab-icon"></span><span class="ab-label">Wooxon</span>';
            ...
            $this->add_wp_toolbar_menu_item( esc_html__( 'Welcome', 'pikoworks_core' ), 'pikoworks', admin_url( 'admin.php?page=pikoworks' ) );
            $this->add_wp_toolbar_menu_item( esc_html__( 'Support', 'pikoworks_core' ), 'pikoworks', admin_url( 'admin.php?page=pikoworks-support' ) );
            $this->add_wp_toolbar_menu_item( esc_html__( 'Theme Options', 'pikoworks_core' ), 'pikoworks', admin_url( 'themes.php?page=theme_options' ) );  
            $this->add_wp_toolbar_menu_item( esc_html__( 'Currency Switcher', 'pikoworks_core' ), 'pikoworks', admin_url( 'admin.php?page=pikowroks_currency' ) );
        }
    }
    ...
    public function admin_menu(){
        ...
        if ( current_user_can( 'edit_theme_options' ) ) {
            $welcome_screen = add_menu_page( 'Wooxon', 'Wooxon', 'administrator', 'pikoworks', array( $this, 'welcome_screen' ), 'dashicons-theme-logo', 59 );
            ...
            $support       = add_submenu_page( 'pikoworks', esc_html__( 'Support', 'pikoworks_core' ), esc_html__( 'Support', 'pikoworks_core' ), 'administrator', 'pikoworks-support', array( $this, 'support_tab' ) );
            $theme_options = add_submenu_page( 'pikoworks', esc_html__( 'Theme Options', 'pikoworks_core' ), esc_html__( 'Theme Options', 'pikoworks_core' ), 'administrator', 'themes.php?page=theme_options' );
        }
    }
    ...
    public function support_tab() {
        require_once( PIKOWORKSCORE_LIBS . '/admin/admin_pages/support.php' );
    }
