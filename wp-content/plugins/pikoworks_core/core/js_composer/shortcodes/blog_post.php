...
$params = array(
    ...
    'params'      => array_merge(array(        
        ...
        array(
            ...
            "param_name" => "size",
            "value"      => array(
        	esc_html__('1770x780px', 'pikoworks_core')     => 'wooxon-image-full-width',
                esc_html__('870x580px', 'pikoworks_core')       => 'wooxon-image-sidebar',
                esc_html__('400x267px', 'pikoworks_core')   => 'wooxon-medium-image',
                esc_html__('570x315px', 'pikoworks_core')     => 'wooxon-2cols-image',
                esc_html__('370x247px', 'pikoworks_core')     => 'wooxon-3cols-image',
                esc_html__('255x147px', 'pikoworks_core') => 'wooxon-4cols-image',
                esc_html__('340x300px', 'pikoworks_core') => 'wooxon-s340',
        	),
            'std'         => 'wooxon-3cols-image',
            'admin_label' => true,
        ),
        array(
            "type"       => "dropdown",
                                ...
                                <div class="entry entry-grid b1">
                                    <figure class="entry-media">
                                        ...
                                        if (!empty($thumbnail)) : ?>                                            
                                                <?php echo wp_kses_post($thumbnail); ?>                                            
                                        <?php endif; ?>
                                        <?php wooxon_entry_masonry_footer(); ?>
                                    </figure>
                                    <div class="entry-content-wrapper">
