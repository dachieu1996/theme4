...
class WPBakeryShortCode_pikoworks_socialpage_link extends WPBakeryShortCode { 
    ...
    protected function content($atts, $content = null) {
        ...
        <div class="<?php echo esc_attr( $css_class ) ?>">
            ...
            if ( trim( $GLOBALS['wooxon']['twitter'] . $GLOBALS['wooxon']['facebook'] . $GLOBALS['wooxon']['googleplus'] . $GLOBALS['wooxon']['dribbble'] . 
                $GLOBALS['wooxon']['behance'] . $GLOBALS['wooxon']['tumblr'] . $GLOBALS['wooxon']['instagram'] . $GLOBALS['wooxon']['pinterest'] .  $GLOBALS['wooxon']['soundcloud'] .
                $GLOBALS['wooxon']['youtube'] . $GLOBALS['wooxon']['vimeo'] . $GLOBALS['wooxon']['linkedin'] . $GLOBALS['wooxon']['flickr'] ) != '' ) {
