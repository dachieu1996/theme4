...
<div class="wrap about-wrap theme-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        printf( '<a href="#" class="nav-tab nav-tab-active">%s</a>', esc_html__( "Currency Switcher", 'pikoworks_core' ) );
        ?>
    </h2>
	...
	<form method="post" action="options.php">
		<?php settings_fields( 'pikowroks_currency' ); ?>
		<?php do_settings_sections( 'pikowroks_currency' ); ?>
		<?php
