...
class pikoworks_widget_newsletter extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $title ) ) {
			$title = '<h5 class="dib pr10 f_s20 f_w5">'.esc_attr($title).'</h5>';
		}
		if ( ! empty( $sub_title ) ) {
			$sub_title = '<span class="pl10 f_w5 c_s2">'.esc_attr($sub_title).'</span>';
		}
		echo '<div class="piko-newsletter"><div class="row align-items-center">'; // The textwidget class is for theme styling compatibility.
